...
type AeMcpServicesRequestLogs struct {
	...
	UserId         string    `gorm:"column:user_id;default:''" json:"user_id"`                // 用户ID
	KeyId          int64     `gorm:"column:key_id;default:0" json:"key_id"`                   // 密钥ID
	XlcreditAmount float64   `gorm:"column:xlcredit_amount;default:0" json:"xlcredit_amount"` // 消费金额
}
